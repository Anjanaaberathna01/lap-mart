              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@lapmart.com<br />sales@lapmart.com</p>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <details className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="mt-4 text-gray-600">
                We offer a 30-day return policy on all laptops. Items must be in original condition 
            ...
            <details className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="mt-4 text-gray-600">
                Yes, all laptops come with manufacturer's warranty. Extended warranty options are 
            ...
            <details className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="mt-4 text-gray-600">
                Yes! Once your order ships, you'll receive a tracking number via email to monitor 
